...
<section id="contenu_site">
	...
	<section id="magasins">
		...
		<article><img src="<?php echo $fleche_bleue; ?>"><a href="http://magasins.bouyguestelecom.fr/" title="Trouvez un magasin Bouygues Telecom" onclick="return xt_adc(this,'int-100001-[Contact::1311::03::Magasins::TrouverUnMagasin]')">Trouvez un magasin Bouygues Telecom</a>
		</article>
