...
<section id="contenu_site">
	...
	<section id="recours">
		...
		<section>
			...
			<section>
				<article><img src="/img/octobre_2013/coche_bleue.png"></article>
				<article>Par t&eacute;l&eacute;phone</article>
				<article><img src="/img/octobre_2013/fleche_bleue.png"><a href="#" title="Cliquez ici" onclick="return xt_adc(this,'int-100001-[Contact::1311::03::Recours::Colonne1ParTelephone]')">Cliquez ici</a></article>			
			</section>
			
			<section>
				<article><img src="/img/octobre_2013/coche_bleue.png"></article>
				<article>Par mail</article>
				<article><img src="/img/octobre_2013/fleche_bleue.png"><a href="#" title="Acc&eacute;der au formulaire" onclick="return xt_adc(this,'int-100001-[Contact::1311::03::Recours::Colonne1AccederAuFormulaire]')">Acc&eacute;der au formulaire</a></article>			
			</section>
		...
		<section>
			...
			<section>
				<article><img src="/img/octobre_2013/coche_bleue.png"></article>
				<article>Par mail</article>
				<article><img src="/img/octobre_2013/fleche_bleue.png"><a href="#" title="Acc&eacute;der au formulaire" onclick="return xt_adc(this,'int-100001-[Contact::1311::03::Recours::Colonne2AccederAuFormulaire]')">Acc&eacute;der au formulaire</a></article>		
			</section>
