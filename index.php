...
<html lang="fr">
    <head>
        ...
        <meta name="description" content="Découvrez nos offres mobiles et Internet. Accédez à votre espace client. Retrouvez l'assistance pour vous accompagner dans l'utilisation de votre équipement.">
        ...
        <link rel="author" href="https://plus.google.com/u/0/112742259362144266973/about" title="Tom OLIVAN"/>
        <link rel="dns-prefetch" href="//ajax.googleapis.com">
        <link rel="canonical" href="http://www.bouyguestelecom.fr">
        <link rel="shortlink" href="bouyguestelecom.fr">

        <link rel="shortcut icon" href="img/hub/ui/ico/favicon.ico">
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="img/hub/ui/ico/apple-touch-icon-144x144-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="img/hub/ui/ico/apple-touch-icon-114x114-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="72x72" href="img/hub/ui/ico/apple-touch-icon-72x72-precomposed.png">
        <link rel="apple-touch-icon-precomposed" href="img/hub/ui/ico/apple-touch-icon-precomposed.png">

        <!--[if lt IE 9]>
        <script src="js/hub/html5shiv.js"></script>
        <![endif]-->
